...
const testimonials = [
  ...
  },
  {
    ...
    content:
      'Our customer engagement has improved dramatically since adopting Caresept. The AI agents provide human-like interactions, and customers often compliment us on our responsiveness',
    featured: true,
  },
];
        ...
        {testimonials.map((testimonial, index) => {
          ...
          return (
            <Card
              ...
              className={`
                flex flex-col
                ${isFeatured ? 'row-span-2 bg-primary text-white' : ''}
            ...
            >
              ...
              <CardContent className="flex-grow">
                <p
                  className={`
                  text-gray-700
                  ${isFeatured ? 'text-lg text-white/90' : 'text-base'}
                `}
                >
                  &apos;{testimonial.content}&apos;
                </p>
