                  ...
                  <TooltipTrigger>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className={`rounded-lg p-2 bg-gradient-to-br from-${item.color.split('-')[1]}-50 to-${item.color.split('-')[1]}-100`}>
                          <item.icon 
                      ...
                      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-gray-200 to-transparent 
